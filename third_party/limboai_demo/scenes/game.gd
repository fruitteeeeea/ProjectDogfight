...
const Simple := preload("res://third_party/limboai_demo/agents/01_agent_melee_simple.tscn")
const Charger := preload("res://third_party/limboai_demo/agents/02_agent_charger.tscn")
const Imp := preload("res://third_party/limboai_demo/agents/03_agent_imp.tscn")
const Skirmisher := preload("res://third_party/limboai_demo/agents/04_agent_skirmisher.tscn")
const Ranged := preload("res://third_party/limboai_demo/agents/05_agent_ranged.tscn")
const Combo := preload("res://third_party/limboai_demo/agents/06_agent_melee_combo.tscn")
const Nuanced := preload("res://third_party/limboai_demo/agents/07_agent_melee_nuanced.tscn")
const Demon := preload("res://third_party/limboai_demo/agents/08_agent_demon.tscn")
const Summoner := preload("res://third_party/limboai_demo/agents/09_agent_summoner.tscn")
...
func _on_switch_to_showcase_pressed() -> void:
	get_tree().change_scene_to_file("res://third_party/limboai_demo/scenes/showcase.tscn")

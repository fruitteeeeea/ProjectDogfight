...
func _initialize() -> void:
	if is_tutorial:
		_populate_agent_files("res://third_party/limboai_demo/agents/tutorial/")
		begin_tutorial.text = "End Tutorial"
		navigation_hint.text = "Navigate ➤"
		scene_title.text = "Tutorial"
		_on_agent_selection_id_pressed(0)
	else:
		_populate_agent_files("res://third_party/limboai_demo/agents/")
...
func _populate_agent_files(p_path: String = "res://third_party/limboai_demo/agents/") -> void:
...
func _on_switch_to_game_pressed() -> void:
	get_tree().change_scene_to_file("res://third_party/limboai_demo/scenes/game.tscn")

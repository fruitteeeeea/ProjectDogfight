...
const MINION_RESOURCE := "res://third_party/limboai_demo/agents/03_agent_imp.tscn"

# Projectile resource.
const NinjaStar := preload("res://third_party/limboai_demo/agents/ninja_star/ninja_star.tscn")
const Fireball := preload("res://third_party/limboai_demo/agents/fireball/fireball.tscn")
